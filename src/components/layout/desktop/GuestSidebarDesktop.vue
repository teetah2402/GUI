...
// File NAME : C:\FLOWORK\flowork-gui\template\web\src\components\layout\desktop\GuestSidebarDesktop.vue total lines 119 
    ...
    <div class="guest-sidebar" :class="{ 'is-open': isOpen }" :style="themeStyles">
      ...
      <div class="sidebar-content">
        <div class="nav-section">
          ...
          <router-link to="/news" class="nav-item" @click="$emit('close')">
            <i class="mdi mdi-newspaper-variant-outline icon"></i><span>News</span>
          </router-link>
        </div>
